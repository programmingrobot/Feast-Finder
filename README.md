...
Set `ADMIN_PASSWORD` before the first run to create the initial admin password. Later password changes are stored locally in `password.txt`, which is ignored by Git.
